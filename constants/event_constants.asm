...
; Viridian City events
	const_next $28											;Next constant is constant number 28 (in hex)
...
; Cinnabar Island events
	...
	const EVENT_EVO_MACHINE_RECHARGING
	const_skip 8
...
; Indigo Plateau events
	...
	const EVENT_908    ;Elite 4 have been beaten ;joenote custom event
	const_skip 2
	const EVENT_90B    ;got dex diploma ;joenote custom event
